...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.PushNotification.PushNotificationManager, Plugin.PushNotification", PushNotificationManager.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PushNotificationManager.class)
			mono.android.TypeManager.Activate ("Plugin.PushNotification.PushNotificationManager, Plugin.PushNotification", "", this, new java.lang.Object[] {  });
	}
